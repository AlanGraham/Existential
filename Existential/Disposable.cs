...
namespace Existential
{
    ...
    /// <summary>
    ///     Contains a method that supports the correct usage of <see cref="IDisposable" /> objects.
    /// </summary>
    public static class Disposable
    {
        /// <summary>
        ///     Creates and initialises an <see cref="IDisposable" /> object of type
        ...
        ///     An <see cref="Action" /> that initialises a type <typeparamref name="T" /> object after it has been created.
        /// </param>
        /// <typeparam name="T">
        ///     The type of the object to be created. It must be <see cref="IDisposable" /> and
